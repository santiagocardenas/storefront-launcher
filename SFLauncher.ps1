...
Write-ToSFLauncherLog "Detecting field names..."
...
Write-ToSFLauncherLog "Login Button Field Name is: $NGUsernameTextBoxName"
Write-ToSFLauncherLog "Password Field Name: $NGPasswordTextBoxName"
